	 ...
	 private Spinner xingqi;
	   ...
	   protected void onCreate(Bundle savedInstanceState) {
	       ...
	       setContentView(R.layout.addlesson);
	         ...
	         mingcheng.setText(intent.getStringExtra("name"));
	         ...
	         int select=getIndex(intent.getStringExtra("xingqi"));
	         xingqi.setSelection(select);
	         
	         jieci1.setText(intent.getStringExtra("jieci1"));
	         jieci2.setText(intent.getStringExtra("jieci2"));
	         classroom.setText(intent.getStringExtra("address"));
